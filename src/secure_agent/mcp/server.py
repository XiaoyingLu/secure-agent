...
if __name__ == "__main__":
    ...
    from secure_agent.tools.calendar_tool import CalendarTool
    from secure_agent.tools.email_tool import EmailTool
    from secure_agent.tools.sharepoint_tool import SharePointTool
    ...
    server_wrapper = MCPToolServer(server_name="secure-agent-tools", tools=registered_tools)
