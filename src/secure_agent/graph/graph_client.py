...
class GraphRateLimitError(GraphClientError):
    """Raised on HTTP 429 ΓÇö Graph is throttling the caller.
...
class GraphNotFoundError(GraphClientError):
    """Raised on HTTP 404 ΓÇö the requested resource does not exist."""
 
 
class GraphServerError(GraphClientError):
    """Raised on HTTP 5xx ΓÇö Graph-side failure."""
...
class GraphClient:
    ...
    def _raise_for_status(self, response: httpx.Response) -> None:
        ...
        if status == 429:
            ...
            logger.warning("Graph 429 ΓÇö throttled. retry_after=%s", retry_after)
    ...
    async def get_messages(
        ...
        Args:
            ...
            top: Maximum number of messages to return (1ΓÇô50).
    ...
    async def search_sharepoint(
        ...
        user can already access.  Graph enforces the user's ACLs ΓÇö no data
        ...
        Args:
            ...
            top: Maximum number of results to return (1ΓÇô25).
    ...
    async def get_events(
        ...
        Raises:
            ...
            GraphRateLimitError: Throttled by Graph.
        """
        # Use calendarView (recommended over /me/events?$filter) ΓÇö it handles
